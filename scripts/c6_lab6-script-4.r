...
# ---- Paths ----
pluto_path <- "~/Desktop/lab_6/data/nyc_mappluto_25v2_1_shp/MapPLUTO.shp"
puma_path  <- "~/Desktop/lab_6/data/nypuma2020_25c/nypuma2020.shp"
