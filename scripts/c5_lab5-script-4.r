...
# --- Tracts (MN03) — % Owner-Occupied Housing Units (ACS 2019–2023, B25032)
...
csv_path <- "~/Desktop/lab_5/data/2020_Census_Tracts_to_2020_NTAs_and_CDTAs_Equivalency_20250903.csv"
...
map_jenks <- make_map(tract_binned, "bin_jenks", "Classification: Jenks (Natural Breaks; 5 bins)")
